...
function add_category(){
	...
	if(new_category_value){
       ...
       document.getElementsByClassName("add-categories")[0].style.display="none";
	}
}
function add_category_page(){
	if(document.getElementsByClassName("add-categories")[0].style.display=="block")
		document.getElementsByClassName("add-categories")[0].style.display="none";
	else
		document.getElementsByClassName("add-categories")[0].style.display="block";
}
